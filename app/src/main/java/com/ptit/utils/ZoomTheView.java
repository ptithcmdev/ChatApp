...
/**
 * Created by nguye on 01-Jul-16.
 */
public class ZoomTheView {
    private Animator mCurrentAnimator;
    private int mShortAnimationDuration;
    public void zoomImageFromThumb(final View thumbView, final ImageView expanded_image, Activity context) {
